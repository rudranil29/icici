...
class DateRangeTimezone extends DateRangeDefaultWidget {
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    ...
    $element['timezone'] = [
      ...
      '#description' => $this->t('This should be the timezone you entered the above date in and will also be the timezone in which this event date is displayed. Everything is in local time for this event.'),
